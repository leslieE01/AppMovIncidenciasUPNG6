...
public class ReporteFragment extends Fragment {
        ...
        settingsButton.setOnClickListener(v -> {
            ...
            popupMenu.setOnMenuItemClickListener(item -> {
                ...
                if (item.getItemId() == R.id.action_historial) {
                    Fragment fragment = new IncidenciasUsuarioFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //tvCorreoUsuario.setText("richard.sanchez@upn.pe");
        ...
        db.collection("usuarios").document(uid)
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(requireContext(), "Error al obtener datos del usuario: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
        ...
        btnEnviarIncidencia.setOnClickListener(v -> {
            if (validarCampos()) {
                ...
                reporte.put("fechaAsignacionSupervisor", null);
                reporte.put("fechaAsignacionTecnico", null);
                ...
                reporte.put("supervisorId", "");
                reporte.put("nombreSupervisor", "");
