...
public class IncidenciaAdapter extends RecyclerView.Adapter<IncidenciaAdapter.IncidenciaViewHolder> {
    ...
    public void onBindViewHolder(@NonNull IncidenciaViewHolder holder, int position) {
        ...
        if (incidencia.getFechaReporte() != null) {
            String fechaFormateada = sdf.format(incidencia.getFechaReporte().toDate());
            holder.tvFechaReporte.setText(fechaFormateada);
        } else {
            holder.tvFechaReporte.setText("No disponible");
        }
    ...
    public static class IncidenciaViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvFechaReporte, tvCategoria, tvSubcategoria, tvPrioridad, tvNombreUsuario, tvEstado;
        Button btnVerDetalle;

        public IncidenciaViewHolder(@NonNull View itemView) {
            super(itemView);

            tvFechaReporte = itemView.findViewById(R.id.tvFechaReporte);
