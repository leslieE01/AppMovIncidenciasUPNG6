            ...
            if (task.isSuccessful()) {
                ...
                if (document != null && document.exists()) {
                    ...
                    if ("usuario".equals(rol)) {
                        ...
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.fragmentContainerView, new com.upn.appincidenciasupn_jm2.Fragmentos.IncidenciasSupervisorFragment())
                                .commit();
                    } else if ("tecnico".equals(rol)) {
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.fragmentContainerView, new com.upn.appincidenciasupn_jm2.Fragmentos.IncidenciasTecnicoFragment())
                                .commit();
                    } else {
